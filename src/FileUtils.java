 ...
 * @param logFileName The 'String' name of the log file.
**/
 ...
 * @param logFile The 'PrintWriter' log file.
**/
 ...
 * @param outFile The 'PrintWriter' output file.
**/
...
/*********************************************************************
 * Method to set the output file given the name of the file.
 * @param outFileName The 'String' name of the output file.
**/
...
**/
  public static void checkArgs(int countArgs,String [] args,String usage)
  {
    ...
    if(countArgs > args.length)
    {
      if(1 == countArgs)
      {
        message  = "ERROR: required " + countArgs + " (" + usage + ") arg not present";
      }
      else
      {
        message  = "ERROR: required " + countArgs + " (" + usage + ") args not present";
      }
 ...
 * @param theFile The 'PrintWriter' file to close.
**/
 ...
 * @param theFile The 'Scanner' file to close.
**/
...
//    FileUtils.logFile.printf("%s enter PrintWriterOpen%n",classLabel);
    ...
    else
    {
      ...
      {
        FileUtils.logFile.println(classLabel + "ERROR opening outFile " + outFileName);
...
//    FileUtils.logFile.printf("%s enter ScannerOpen%n",classLabel);
    ...
    else
    {
      ...
      {
        FileUtils.logFile.println("classLabel + ERROR opening inFile " + inFileName);
        FileUtils.logFile.println(ex.getMessage());
        FileUtils.logFile.println("in" + System.getProperty("user.dir"));
        FileUtils.logFile.flush();
        System.exit(1);
