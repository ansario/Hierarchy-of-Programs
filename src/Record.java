...
//  private final String classLabel = "Record: "; // for debugging
  ...
  private String time;   /** the office'hours'              */
/*********************************************************************
 * Constructor.
**/
  public Record()
  {
    ...
    this.setTime(Record.DUMMYSTRING);
  } // public Record()
...
**/
 ...
 /*********************************************************************
  * Accessor for the <code>time</code>.
   *
...
public String getTime()
{
  ...
  /*********************************************************************
   * Mutator for the <code>time</code>.
   *
   * @return the value of <code>time</code>
  **/
public void setTime(String what)
{
  this.time = what;
} // public void setTime(String what)
...
**/
  ...
  {
    String s;
    s = String.format("%-10s %-5s %-9s %4d %18s",
